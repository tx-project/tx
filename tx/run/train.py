...
def train(
    ...
    report_params: str = typer.Option("{}", "--report-params", help="Parameters that will be passed to the experiment tracker (in JSON format)"),
) -> None:
    ...
    tracker = get_tracker(report_to, config, **json.loads(report_params))
